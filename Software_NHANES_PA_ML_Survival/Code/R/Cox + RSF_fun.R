...
df <- baseline %>%
  dplyr::select(Age, Race, BMI,height, sex, Mobility, mortstat, diabetes.y, poverty_level, 
...
cox_model2 <- coxph(Surv(time_mort, mortstat) ~ Age + sex:height, data = dfrfs) #do in whole data
